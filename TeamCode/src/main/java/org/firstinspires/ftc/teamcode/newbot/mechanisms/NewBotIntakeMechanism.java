...
public final class NewBotIntakeMechanism {
    ...
    public NewBotIntakeMechanism(HardwareMap hardwareMap, Telemetry telemetry) {

        intake = hardwareMap.get(DcMotorEx.class, NewBotConstants.INTAKE_MOTOR_NAME);
