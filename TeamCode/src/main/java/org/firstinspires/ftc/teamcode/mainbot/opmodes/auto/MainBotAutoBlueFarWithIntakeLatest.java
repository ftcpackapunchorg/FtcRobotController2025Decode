...
public class MainBotAutoBlueFarWithIntakeLatest extends LinearOpMode {
    ...
    /* ---------------- POSES (FAR, MeepMeep) ---------------- */
    Pose2d startPose = new Pose2d(65, -12, Math.toRadians(180));

    Pose2d farLaunchPose = new Pose2d(56, -12, Math.toRadians(205));

    Pose2d farParkPose = new Pose2d(46, -27, Math.toRadians(180));

    Pose2d intake1Start = new Pose2d(36, -23, Math.toRadians(270));
    Pose2d intake1End   = new Pose2d(36, -53, Math.toRadians(270));

    Pose2d intake2Start = new Pose2d(12, -23, Math.toRadians(270));
    Pose2d intake2End   = new Pose2d(12, -53, Math.toRadians(270));
