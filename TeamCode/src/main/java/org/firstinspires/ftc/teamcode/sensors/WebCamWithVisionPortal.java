...
public class WebCamWithVisionPortal {
...
//        builder.setAutoStopLiveView(false);
    ...
    public void resumeVisionPortalStreaming() {
        if(visionPortal != null) {
            visionPortal.resumeStreaming();
        }
    }

    public void stopVisionPortalStreaming() {
        if(visionPortal != null) {
            visionPortal.stopStreaming();
        }
    }

    public void setProcesorEnabled() {
        visionPortal.setProcessorEnabled(aprilTag, true);
    }

    public void setProcesorDisabled() {
