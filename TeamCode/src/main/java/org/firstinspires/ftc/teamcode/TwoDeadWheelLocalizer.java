...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1784.9314463276362; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1844.4908506215304; // x position of the perpendicular encoder (in tick units)
    }
