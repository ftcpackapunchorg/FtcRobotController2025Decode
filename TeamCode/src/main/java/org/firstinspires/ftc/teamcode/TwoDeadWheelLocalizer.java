...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1775.125692590317; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 1845.9979592094453; // x position of the perpendicular encoder (in tick units)
    }
