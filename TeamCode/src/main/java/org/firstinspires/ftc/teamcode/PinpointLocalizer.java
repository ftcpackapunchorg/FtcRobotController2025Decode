...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 0.75 * 25.4; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -6 * 25.4; // x position of the perpendicular encoder (in tick units)
    }
