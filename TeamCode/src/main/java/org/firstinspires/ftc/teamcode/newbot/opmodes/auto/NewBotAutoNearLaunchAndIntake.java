...
@Autonomous(name = "NewBotAutoNearLaunchAndIntake", group = "NewBot")
public class NewBotAutoNearLaunchAndIntake extends LinearOpMode {
    ...
    private double STOP_AUTO_MODE_FOR_LEAVE = 25;
    ...
    Pose2d intake1  = new Pose2d(-12, -34, Math.toRadians(-90));
...
//                        .strafeToLinearHeading(new Vector2d(intake3.position.x, intake3.position.y), intake3.heading);
        ...
        intakeTrajectory = currTrajectory.endTrajectory().fresh()
                        ...
                        .waitSeconds(.5)
                        .strafeToLinearHeading(new Vector2d(xIntakeInch, yIntakeInch - 5), headingRadiansIntake, new TranslationalVelConstraint(15.0))
                        .waitSeconds(.5)
                        .strafeToLinearHeading(new Vector2d(xIntakeInch, yIntakeInch - 10), headingRadiansIntake, new TranslationalVelConstraint(15.0));
//                        .waitSeconds(.5)
