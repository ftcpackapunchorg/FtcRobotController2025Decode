package org.firstinspires.ftc.teamcode.newbot.sensors;
...
public class NewBotColorSensor {
...
//        telemetry.addData("Blue", "%.3f", colors.blue);
        ...
        telemetry.addData("Sensor Name : " + sensorName + "Hue : ", JavaUtil.colorToHue(colors.toColor()));
